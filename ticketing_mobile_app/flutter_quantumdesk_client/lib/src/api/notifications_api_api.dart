...
class NotificationsApiApi {
  ...
  const NotificationsApiApi(this._dio, this._serializers);
  ...
  Future<Response<void>> apiNotificationsApiIdMarkAsReadPatch({ 
    required int id,
    ...
    final _path = r'/api/NotificationsApi/{id}/MarkAsRead'.replaceAll('{' r'id' '}', encodeQueryParameter(_serializers, id, const FullType(int)).toString());
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> apiNotificationsApiPost({ 
    String? userId,
    String? title,
    String? message,
    CancelToken? cancelToken,
    ...
    final _path = r'/api/NotificationsApi';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<BuiltList<Notification>>> apiNotificationsApiUserUserIdGet({ 
    ...
    final _path = r'/api/NotificationsApi/User/{userId}'.replaceAll('{' r'userId' '}', encodeQueryParameter(_serializers, userId, const FullType(String)).toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
