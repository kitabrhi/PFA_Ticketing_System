...
namespace Ticketing_System.Controllers
{
    ...
    public class TeamMemberController : Controller
    {
        ...
        public async Task<IActionResult> Create(TeamMember member)
        {
            ...
            // V�rifier que l'utilisateur est un SupportAgent
        ...
        public async Task<IActionResult> Teams()
        {
            ...
            // Si l'utilisateur est un administrateur, afficher toutes les �quipes
            ...
            // Pour un agent, r�cup�rer uniquement les �quipes dont il est membre
